...
entry_8.place(x=809.0, y=505.0, width=241.0, height=24.0)
...
button_3.place(x=908.0, y=99.0, width=173.0, height=20.0)
...
button_4.place(x=893.0, y=610.0, width=173.0, height=30.0)
...
button_5.place(x=758.0, y=39.0, width=80.0,height=35.0)
...
button_6.place(x=21.0, y=252.0, width=160.0, height=32.0)
